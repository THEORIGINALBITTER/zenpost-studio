...
- **Multi-Format Support**: Convert between JSON, Markdown, HTML, Text, PDF, and Code
...
│   ├── ConverterScreen.tsx        # Main converter orchestrator
│   └── converter-steps/           # Modular step components
...
│       └── ZenSubtitle.tsx
├── services/
│   └── aiService.ts               # AI provider configuration
└── utils/
    └── fileConverter.ts           # File conversion logic
```
