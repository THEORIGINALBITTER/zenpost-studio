...
export const FEATURES: Record<string, FeatureFlag> = {
  ...
  DOC_STUDIO: {
    id: 'DOC_STUDIO',
    name: 'Doc Studio',
    description: 'Projekt analysieren, Dokumente generieren und technische Inhalte zentral bearbeiten',
    tier: 'pro',
    category: 'studio',
  },
  DOC_WIZARD: {
    id: 'DOC_WIZARD',
    name: 'Doc Wizard',
    description: 'Docs-Sites, GitHub Pages und Vorlagen direkt aus Markdown generieren',
    tier: 'pro',
    category: 'studio',
  },
  BLOCK_EDITOR: {
    id: 'BLOCK_EDITOR',
    name: 'Block Editor',
    description: 'Dokumente modular bearbeiten, strukturieren und schneller pflegen',
    tier: 'pro',
    category: 'editor',
  },
  ...
  EXPORT_PDF: {
    id: 'EXPORT_PDF',
    name: 'Export as PDF',
    description: 'Dokumentation als sauber formatiertes PDF exportieren',
    tier: 'pro',
    category: 'export',
  },
  EXPORT_HTML: {
    id: 'EXPORT_HTML',
    name: 'Export as HTML',
    description: 'Dokumente als HTML für Web-Dokumentation ausgeben',
    tier: 'pro',
    category: 'export',
  },
  ...
  AI_TEXT_PREVIEW: {
    ...
    description: 'Texte im Editor prüfen, umformulieren und sprachlich verbessern',
    tier: 'pro',
    category: 'ai',
  },
  AI_AUTO_FORMAT: {
    id: 'AI_AUTO_FORMAT',
    name: 'AI Auto-Format',
    description: 'Abschnitte automatisch strukturieren und in ein sauberes Format bringen',
    tier: 'pro',
    category: 'ai',
  },
  ...
  GITHUB_INTEGRATION: {
    ...
    description: 'Dokumente direkt mit deinem Repository synchronisieren und veröffentlichen',
    tier: 'pro',
    category: 'integration',
  },
  CONTENT_CALENDAR: {
    ...
    description: 'Inhalte planen und Veröffentlichungsschritte koordinieren',
    tier: 'pro',
    category: 'integration',
  },
};
