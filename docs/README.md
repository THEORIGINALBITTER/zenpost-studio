...
- [KI-Uebersicht](ai/overview.md) — Lokal vs Cloud, Provider-Vergleich
- [Ollama (Lokal)](ai/ollama.md) — Schritt-fuer-Schritt Setup
- [Cloud-Provider](ai/cloud.md) — OpenAI, Anthropic, Custom

## Hilfe

- [FAQ](help/faq.md) — Haeufige Fragen
- [Allgemeine Probleme](help/general.md) — App, Export, Dateien
- [KI-Fehlerbehebung](help/ai.md) — CORS, Verbindung, API-Keys

Nutze die Sidebar links fuer die Navigation.
