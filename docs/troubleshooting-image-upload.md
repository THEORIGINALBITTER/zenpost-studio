...
Beispiel: App nutzt /upload*image.php**, Server-Logik liegt aber in /upload*images.php.

1. Upload schreibt in falschen Ordner.

Beispiel: Script schreibt nach /stage01/images/..., URL zeigt aber auf /images/....

1. Rueckgabe-URL passt nicht zum echten Dateipfad.

Datei existiert, aber unter anderem Pfad als in der URL.

1. CORS blockiert Upload aus der App/WebView.

Beispiel: Origin http://127.0.0.1:1420 is not allowed.

1. Dateiname/Extension wird falsch erzeugt.
...
1. Export zeigt Erfolg nur bei vollstaendigem Upload + Save.
2. API-UI verbessert:
...
[Schreib mir eine Email](saghallo@denisbitter.de)